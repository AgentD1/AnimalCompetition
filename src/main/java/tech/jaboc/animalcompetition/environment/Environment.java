...
public class Environment {
	...
	public static Environment generateEnvironment(JsonEnvironmentalFactorList factorList) {
		...
		for (int traitNum = 0; traitNum < numTraits; traitNum++) {
			...
			EnvironmentalFactor[] allFactors = Stream.concat(Arrays.stream(
							...
							features.stream())
					.toArray(EnvironmentalFactor[]::new); // Get all current factors in the ugliest "1-liner" possible
	...
	@Override
	public String toString() { // Autogenerated by idea :)
		return "Environment {" +
				"time=" + timeFactor +
	...
	/**
	 * Represents a list of all types of environmental factors. Should only be used for storage in files, as it isn't very nice
	 *
	 * @param times        The time factors
	 * @param terrains     The terrain factors
	 * @param temperatures The temperature factors
	 * @param weathers     The weather factors
	 * @param features     The feature factors
	 */
